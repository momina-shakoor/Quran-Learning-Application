  ...
  const quizHistory = [
    {
      ...
      feedback: "The course was very informative and well-structured.",
    },
    {
      date: "2024-05-29",
      totalXp: "30",
      ...
      <div className="w-[80%] p-3 ml-[20%] ">
        ...
        <div className=" p-2">
          ...
          {quizHistory.map((item, key) => (
            <div
              key={key}
              className="p-2 bg-blue-500 mb-2 text-white flex flex-wrap items-center "
            >
              <div className="w-[60%]">
              ...
              <div
                className="text-blue-600 bg-white px-2 rounded-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
